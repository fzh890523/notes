...
![ResourceSource connection setup](_pics/ResourceSource-connection-setup.svg)
...
![ResourceSink connection setup](_pics/ResourceSink-connection-setup.svg)
...
![Resource full-state update success](_pics/collection-full-state-update-success.svg)
...
![Resource full-state incremental success](_pics/collection-incremental-update-success.svg)

### Error example

The following example shows what happens when a change cannot be applied.

![Resource update error](_pics/collection-update-error.svg)
